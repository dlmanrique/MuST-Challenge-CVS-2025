...
EXPERIMENT_NAME="$ARCH-chunks_$NUM_CHUNKS-overlap_$OVERLAPPING-dmodel_$S_D_MODEL-catdim_$S_CAT_DIM-layers_$S_LAYERS-heads_$S_HEADS-opt_$OPT-lr_$LR"
...
CUDA_VISIBLE_DEVICES=2 python -B tools/run_net.py \
--cfg $CONFIG_PATH \
NUM_GPUS 1 \
CHUNKS.CHUNK_SIZE $NUM_CHUNKS \
CHUNKS.OVERLAPPING $OVERLAPPING \
TRAIN.DATASET "Heicholechunks" \
TEST.DATASET "Heicholechunks" \
