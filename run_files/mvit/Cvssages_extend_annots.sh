...
if [ "$MINI" = "true" ]; then
    ...
    COCO_ANN_PATH="./data/"$DATASET"/"$DATA_TYPE"/annotations/$TEST_FOLD"_"long-term_extend_annots.json"
    TRAIN_GT_BOX_JSON="$TRAIN_FOLD"_"long-term_extend_annots.json"
    TEST_GT_BOX_JSON="$TEST_FOLD"_"long-term_extend_annots.json"
...
ENDOVIS_DATASET.TRAIN_LISTS $TRAIN_FOLD"_fps_"$FPS".csv" \
ENDOVIS_DATASET.TEST_LISTS $TEST_FOLD"_fps_"$FPS".csv"  \
